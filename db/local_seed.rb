...
v.thumbnail.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/lionking.jpg"),filename: "lionking.jpg")
v.clip.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/lionking.mp4"),filename: "lionking.mp4")
path = File.join('/mnt','h','Movies','The Lion King (1994)','The.Lion.King.1994.BluRay.720p.x264.YIFY.mp4')
v.video.attach(io: File.open(path),filename: 'The.Lion.King.1994.BluRay.720p.x264.YIFY.mp4')
...
v.thumbnail.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/beautyandthebeast.jpg"),filename: "beautyandthebeast.jpg")
v.clip.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/beautyandthebeast.mp4"),filename: "beautyandthebeast.mp4")
path = File.join('/mnt','h','Movies','Beauty and the Beast (1991)','Beauty and the Beast 1991.EXTENDED.720p.BrRip.x264.YIFY.mp4')
v.video.attach(io: File.open(path),filename: 'Beauty and the Beast 1991.EXTENDED.720p.BrRip.x264.YIFY.mp4')
...
v.clip.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/aladdin.mp4"),filename: "aladdin.mp4")
v.thumbnail.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/aladdin.jpg"),filename: "aladdin.jpg")
path = File.join('/mnt','h','Movies','Aladdin (1992)','Aladdin.1992.720p.BRrip.x264.GAZ.YIFY.mp4')
v.video.attach(io: File.open(path),filename: 'Aladdin.1992.720p.BRrip.x264.GAZ.YIFY.mp4')
...
v.clip.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/cars.mp4"),filename: "cars.mp4")
v.thumbnail.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/cars.jpg"),filename: "cars.jpg")
path = File.join('/mnt','h','Movies','Cars (2006)','Cars.2006.720p.BrRip.x264.YIFY.mp4')
v.video.attach(io: File.open(path),filename: 'Cars.2006.720p.BrRip.x264.YIFY.mp4')
...
v.clip.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/cloudywithachanceofmeatballs.mp4"),filename: "cloudywithachanceofmeatballs.mp4")
v.thumbnail.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/cloudywithachanceofmeatballs.jpg"),filename: "cloudywithachanceofmeatballs.jpg")
path = File.join('/mnt','h','Movies','Cloudy with a Chance of Meatballs (2009)','Cloudy.with.a.Chance.of.Meatballs.720p.BluRay.x264.YIFY.mp4')
v.video.attach(io: File.open(path),filename: 'Cloudy.with.a.Chance.of.Meatballs.720p.BluRay.x264.YIFY.mp4')
...
v.clip.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/burnt.mp4"),filename: "burnt.mp4")
v.thumbnail.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/burnt.jpg"),filename: "burnt.jpg")
path = File.join('/mnt','h','Movies','Burnt (2015)','Burnt.2015.720p.BluRay.x264.[YTS.AG].mp4')
v.video.attach(io: File.open(path),filename: 'Burnt.2015.720p.BluRay.x264.[YTS.AG].mp4')
...
v.clip.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/charliechaplin.mp4"),filename: "charliechaplin.mp4")
v.thumbnail.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/charliechaplin.jpg"),filename: "charliechaplin.jpg")
path = File.join('/mnt','h','Movies','Charlie Chaplin - Modern Times (1936)','Charlie.Chaplin.Modern.Times.1936.720p.BrRip.x264.YIFY.mp4')
v.video.attach(io: File.open(path),filename: 'Charlie.Chaplin.Modern.Times.1936.720p.BrRip.x264.YIFY.mp4')
...
v.thumbnail.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/dearjohn.jpg"),filename: "dearjohn.jpg")
v.clip.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/dearjohn.mp4"),filename: "dearjohn.mp4")
path = File.join('/mnt','h','Movies','Dear John (2010)','Dear.John.2010.720p.BluRay.x264.YIFY.mp4')
v.video.attach(io: File.open(path),filename: 'Dear.John.2010.720p.BluRay.x264.YIFY.mp4')
...
v.thumbnail.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/kungfuhustle.jpg"),filename: "kungfuhustle.jpg")
v.clip.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/kungfuhustle.mp4"),filename: "kungfuhustle.mp4")
path = File.join('/mnt','h','Movies','Kung Fu Hustle (2004)','Kung Fu Hustle 2004.720p.BrRip.x264.YIFY.mp4')
v.video.attach(io: File.open(path),filename: 'Kung Fu Hustle 2004.720p.BrRip.x264.YIFY.mp4')
...
v.thumbnail.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/spiderman.png"),filename: "spiderman.png")
v.clip.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/spiderman.mp4"),filename: "spiderman.mp4")
path = File.join('/mnt','h','Movies','Spider-Man Homecoming (2017) [YTS.AG]','Spider-Man.Homecoming.2017.720p.BluRay.x264-[YTS.AG].mp4')
v.video.attach(io: File.open(path),filename: 'Spider-Man.Homecoming.2017.720p.BluRay.x264-[YTS.AG].mp4')
...
v.thumbnail.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/splice.jpg"),filename: "splice.jpg")
v.clip.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/splice.mp4"),filename: "splice.mp4")
path = File.join('/mnt','h','Movies','Splice (2009) [1080p]','Splice.2009.1080p.BrRip.x264.YIFY.mp4')
v.video.attach(io: File.open(path),filename: 'Splice.2009.1080p.BrRip.x264.YIFY.mp4')
...
v.thumbnail.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/titanic.jpg"),filename: "titanic.jpg")
v.clip.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/titanic.mp4"),filename: "titanic.mp4")
path = File.join('/mnt','h','Movies','Titanic (1997)','Titanic.1997.720p.HDTV.x264-YIFY.mp4')
v.video.attach(io: File.open(path),filename: 'Titanic.1997.720p.HDTV.x264-YIFY.mp4')
...
v.thumbnail.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/whyhim.jpg"),filename: "whyhim.jpg")
v.clip.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/whyhim.mp4"),filename: "whyhim.mp4")
path = File.join('/mnt','h','Movies','Why Him (2016) [YTS.AG]','Why.Him.2016.720p.BluRay.x264-[YTS.AG].mp4')
v.video.attach(io: File.open(path),filename: 'Why.Him.2016.720p.BluRay.x264-[YTS.AG].mp4')
...
v.thumbnail.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/thelongestride.jpg"),filename: "thelongestride.jpg")
v.clip.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/thelongestride.mp4"),filename: "thelongestride.mp4")
path = File.join('/mnt','h','Movies','The Longest Ride (2015)','The.Longest.Ride.2015.720p.BluRay.x264.YIFY.mp4')
v.video.attach(io: File.open(path),filename: 'The.Longest.Ride.2015.720p.BluRay.x264.YIFY.mp4')
...
v.thumbnail.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/ipman.jpg"),filename: "ipman.jpg")
v.clip.attach(io: File.open("/mnt/c/Users/weini/Downloads/and-chill-seeds/ipman.mp4"),filename: "ipman.mp4")
path = File.join('/mnt','h','Movies','IP Man (2008)','Ip Man 2008.720p.BrRip.x264.YIFY.mp4')
v.video.attach(io: File.open(path),filename: 'Ip Man 2008.720p.BrRip.x264.YIFY.mp4')
